...
filters = (
    ...
    # this is just here to remember that we have more filters to add at a later
    # time
    # ('Document type', (
    #     ("Docs", "This will restrict the search to docs "
    #              "content, leaving out Hacks and other MDN content."),
    #     ("Demos", "This will include Demo Studio "
    #               "content in the search results."),
    #     ("Tools", "Tools"),
    #     ("Code Samples", "Example"),
    #     ("How-To & Tutorial", "Guide"),
    #     ("Developer Profiles",
    #         "This will include developer profiles "
    #         "from the MDN site in the search results."),
    #     ("External Resources",
    #         "This is something the dev team will need to figure out."),
    # )),
)
